...
public class TokenFactory {
    ...
    private static final Map<String, TokenType> keywords = new HashMap<>() {
        {
            ...
            put(TokenType.K_EXTENDS.toString(), TokenType.K_EXTENDS);
            put(TokenType.K_METH.toString(), TokenType.K_METH);
            put(TokenType.K_CONSTR.toString(), TokenType.K_CONSTR);
            put(TokenType.K_SUPER.toString(), TokenType.K_SUPER);
            put(TokenType.K_PUBLIC.toString(), TokenType.K_PUBLIC);
            put(TokenType.K_PROTECTED.toString(), TokenType.K_PROTECTED);
            put(TokenType.K_PRIVATE.toString(), TokenType.K_PRIVATE);
            ...
            put(TokenType.K_VAR.toString(), TokenType.K_VAR);
            put(TokenType.K_FCALL.toString(), TokenType.K_FCALL);
            put(TokenType.K_MCALL.toString(), TokenType.K_MCALL);
            ...
            put(TokenType.K_HOME.toString(), TokenType.K_HOME);
    ...
    public Token createToken(String value, TokenState state) {
        return switch (state) {
            ...
            case S_COLON -> makeToken(TokenType.S_COLON, value);
            ...
            case S_NOT -> makeToken(TokenType.S_NOT_ALT, value);
            case S_NOT_EQ -> makeToken(TokenType.S_NEQ, value);
            case S_OR_E -> makeToken(TokenType.S_OR_ALT, value);
